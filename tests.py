...
class TestBooksCollector:
    ...
    def test_add_new_book_add_book_1_and_40_len(self, name, collector):
    ...
    def test_add_new_book_not_add_0_and_41_len(self, name, collector):
        collector.add_new_book(name)
        list_name = collector.get_books_genre()
    ...
    def test_get_books_with_specific_genre(self, collector):
        ...
        for book in ["Война миров", "Приключения Тома Сойера", "Маугли"]:
            assert book not in list_genre
    ...
    def test_delete_book_from_favorites(self, collector):
        ...
        assert "Маугли" in collector.favorites
        collector.delete_book_from_favorites('Маугли')
        assert 'Маугли' not in collector.favorites
